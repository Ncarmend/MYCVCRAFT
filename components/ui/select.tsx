  ...
  <div className="flex flex-col gap-0.5">
    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus:outline-none focus:ring-2 focus:ring-emerald-800 focus:border-emerald-800",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-[8rem] overflow-hidden rounded-xl border border-gray-100",
        "bg-white shadow-lg animate-in fade-in-0 zoom-in-95",
        position === "popper" &&
          "translate-y-1 data-[side=bottom]:translate-y-1",
        className
      )}
      position={position}
      {...props}
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-emerald-50 focus:text-emerald-800",
