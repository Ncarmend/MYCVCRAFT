...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      faqs: [
        { q: "Can I cancel anytime?",                       a: "Yes. Cancel your Pro subscription any time from your account settings. You retain Pro access until the end of your billing period." },
        ...
        { q: "Is there a free trial?",                      a: "Yes — Pro comes with a 7-day free trial. No credit card required to sign up for the Free plan." },
  ...
  fr: {
    ...
    pricing: {
      ...
      faqs: [
        { q: "Puis-je annuler à tout moment ?",                          a: "Oui. Annulez votre abonnement Pro à tout moment depuis les paramètres de votre compte. Vous conservez l'accès Pro jusqu'à la fin de votre période de facturation." },
        ...
        { q: "Y a-t-il un essai gratuit ?",                              a: "Oui — Pro est fourni avec un essai gratuit de 7 jours. Aucune carte bancaire requise pour s'inscrire au plan Gratuit." },
