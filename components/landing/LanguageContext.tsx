...
export const translations = {
  en: {
    ...
    cvForm: {
      ...
      ai: {
        upgradeNotice:           "ATS Check is free. Upgrade to Pro to unlock job matching and cover letter generation.",
  ...
  fr: {
    ...
    cvForm: {
      ...
      ai: {
        upgradeNotice:          "La vérification ATS est gratuite. Passez à Pro pour débloquer le matching d'offre et la génération de lettre de motivation.",
