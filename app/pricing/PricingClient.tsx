...
export function PricingClient() {
  ...
  useEffect(() => {
    fetch("/api/subscription/status")
      .then((r) => r.json())
      .then((d: SubscriptionStatus) => { if (d.plan_type) setSubStatus(d); })
      .catch(() => {});
  }, []);
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-5xl px-6 pb-6 pt-6 text-center">
        <h1 className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">{T.headline}</h1>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-6">
        <div className="mb-4 text-center">
          <p className="text-[8px] font-semibold uppercase tracking-widest text-slate-400">{TM.yourCVs}</p>
                ...
                <div className="grid grid-cols-12" style={{ minHeight: "380px" }}>
                  <div className="col-span-2 flex flex-col border-r border-gray-100 bg-white/70 p-2">
                    ...
                    <div className="space-y-1.5 text-gray-600">
                      {TM.nav.map((label: string, i: number) => (
                        <div key={i} className={`flex items-center gap-2 rounded-md px-3 py-2 ${i === 0 ? "bg-emerald-100 text-emerald-700 shadow-sm" : "text-gray-500"}`}>
                  ...
                  <div className="col-span-10 bg-gray-50/40 p-5">
                    ...
                    <div className="mb-5 grid grid-cols-4 gap-3">
                      {TM.stats.map((s: { label: string; value: string }, i: number) => (
                    ...
                    <p className="mb-2 text-[9px] font-semibold uppercase tracking-wide text-gray-500">{TM.yourCVs}</p>
                    <div className="grid grid-cols-3 gap-2">
                      <div className="overflow-hidden rounded-xl border border-indigo-100 bg-white shadow-sm">
                        ...
                        <div className="p-3">
                          ...
                          <div className="flex gap-1.5">
                            <span className="rounded-md bg-green-100 px-1.5 py-0.5 text-[9px] font-semibold text-green-700">{TM.published}</span>
                      ...
                      <div className="overflow-hidden rounded-xl border border-purple-100 bg-white shadow-sm">
                        ...
                        <div className="p-2">
                          ...
                          <div className="flex gap-1.5">
                            <span className="rounded-md bg-amber-100 px-1.5 py-0.5 text-[9px] font-semibold text-amber-700">{TM.draft}</span>
      ...
      <div className="border-t border-slate-100 bg-white py-10">
        <div className="mx-auto max-w-2xl px-6">
          ...
          <div className="space-y-2">
            {T.faqs.map((faq) => (
              <div key={faq.q} className="rounded-lg bg-slate-50 px-4 py-3 ring-1 ring-slate-100">
